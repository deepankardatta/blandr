...
blandr.proportional.bias <- function( method1 , method2 , method1name = "Method 1" , method2name = "Method 2",
    plotTitle = "Bland-Altman plot with regression line" , sig.level = 0.95 , LoA.mode = 1 , ciDisplay = FALSE,
    ciShading = FALSE , normalLow = FALSE , normalHigh = FALSE , lowest_y_axis = FALSE , highest_y_axis = FALSE ) {
    ...
    # The vignette has instructions how to take the ba.plot output to customise axes
    # Passed data to the blandr.plot.limits function to work out the axes limits
