...
#' blandr.draw( measurement1 , measurement2 , plotTitle = "Bland-Altman example plot" , ciDisplay = FALSE , ciShading = FALSE )
#'
#' @export

blandr.draw <- function( method1 , method2 , plotter = "ggplot" , method1name = "Method 1",
