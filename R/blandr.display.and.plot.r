#' Bland-Altman display and plot for R
#'
...
#' @description Is a copy of the Bland-Altman idsplay and draw function
#'
...
blandr.display.and.plot <- function(method1, method2, method1name = "Method 1", method2name = "Method 2", plotTitle = "Bland-Altman plot for comparison of 2 methods",
    ...
    blandr.display.and.draw(method1, method2, method1name, method2name, plotTitle, sig.level, annotate, ciDisplay,
        ciShading, normalLow, normalHigh, lowest_y_axis, highest_y_axis, point_size)
