...
blandr.display.and.draw <- function(method1, method2, plotter = "ggplot", method1name = "Method 1", method2name = "Method 2", plotTitle = "Bland-Altman plot for comparison of 2 methods",
  ...
  blandr.draw(method1, method2, plotter, method1name, method2name, plotTitle, sig.level, annotate, ciDisplay, ciShading,
