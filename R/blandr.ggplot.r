#' @title Bland-Altman plotting function, using ggplot
#'
#' @description Draws a Bland-Altman plot using data calculated using the other functions, using ggplot
#'
...
blandr.ggplot <- function ( statistics.results , method1name="Method 1" , method2name="Method 2" , plotTitle="Bland-Altman plot for comparison of 2 methods" , ciDisplay=TRUE , ciShading=TRUE , normalLow=FALSE , normalHigh=FALSE ) {

  plot.data <- data.frame( statistics.results$differences , statistics.results$means )

  ba.plot <- ggplot( plot.data , aes( statistics.results$means , statistics.results$differences ) ) +
    geom_point() +
